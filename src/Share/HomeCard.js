      ...
      <div className="w-full mb-6 lg:mb-0  mx-auto   relative bg-white text-center px-6 rounded-[20px] mt-[180px] md:mt-[220px] lg:mt-0 ">
        ...
        <div className="pt-[100px] pb-8">
          ...
          <a
            href={cvFile}
            download
            className="inline-flex items-center mx-auto bg-gradient-to-r from-[#a9aa71] to-[#a9aa71] duration-200 transition ease-linear hover:bg-gradient-to-l from-[#a9aa71]  to-[#a9aa71] px-8 py-3 text-lg text-white rounded-[35px] mt-6"
          >
