...
const HeaderTwo = () => {
  ...
  return (
    <header className="lg:w-[526px] h-[144px] hidden lg:block  p-[30px] ml-auto mb-10  rounded-[16px] bg-white">
      ...
      <nav className={`${menuOpen ? "block mx-auto" : "hidden lg:block"}`}>
        ...
        >
          {menuItemTwo.map((item) => (
            <NavLink
              key={item.id}
              activeClassName=" text-white  bg-gradient-to-r from-[#a9aa71] to-[#a9aa71] linked"
              inactiveClassName=" transition-all duration-300 ease-in-out dark:hover:text-white hover:text-white   hover:bg-gradient-to-r from-[#a9aa71] to-[#a9aa71]  "
              className={`${
                ...
                a.pathname === "/homeTwo" && item.id === "01"
                  ? " lg:text-white  lg:bg-gradient-to-r from-[#a9aa71] to-[#a9aa71] "
                  : " "
              }`}
              to={item?.link}
            >
